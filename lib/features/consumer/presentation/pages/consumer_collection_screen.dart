...
class _ConsumerCollectionScreenState
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      prodResult.fold(
        (f) => setState(() => _error = _error ?? normalizeNetworkErrorMessage(f.message)),
    ...
    return Column(
      ...
      children: [
        ...
        TabBar(
          ...
          labelColor: ConsumerTheme.primaryText,
          unselectedLabelColor: ConsumerTheme.muted,
                                      ...
                                      child: Container(
                                        ...
                                        child: ReviewCard(
                                          ...
                                          onLikeChangedWithState: (isNowLiked) {
                                            ...
                                            setState(() {
                                              final idx = _savedReviews.indexWhere((e) => e.id == review.id);
                                              if (idx >= 0) {
                                                final r = _savedReviews[idx];
                                                final newLikedBy = isNowLiked
                                                    ? [...r.likedBy, authId]
                                                    : r.likedBy.where((id) => id != authId).toList();
                                                _savedReviews = List.from(_savedReviews)
                                                  ..[idx] = r.copyWith(
                                                    likedBy: newLikedBy,
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: ProductCard(
                                              ...
                                              onSaveChanged: () async {
                                                ...
                                                await ref
                                                    .read(collectionRepositoryProvider)
                                                    .unsaveProduct(authId, product.id);
                                                if (mounted) setState(() {
